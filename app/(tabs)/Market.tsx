...
const styles = StyleSheet.create({
  ...
  statusBadge: {
    ...
    borderRadius: 4,
    borderWidth: 1,
    backgroundColor: 'rgba(11,25,42,0.9)',
  },
  statusDot: {
    width: 6,
    height: 6,
  ...
  statLabel: { fontFamily: mono, fontSize: 9, color: MUTED, letterSpacing: 1.5 },
  statValue: { fontFamily: mono, fontSize: 12, color: TXT, fontWeight: '700' },
  scrollContent: {
    padding: 16,
    paddingBottom: 60,
  },
  ...
  errorTitle: { fontFamily: sans, fontSize: 16, fontWeight: '700', color: TXT, textAlign: 'center' },
